const yearOptions = ['2013','2014','2015','2016','2017', '2018', '2019','2020','2021','2022'];
...
const availableLanguagesOptions = [{name:'Français', key:'fr'}, {name:'Deutsch', key:'de'}, {name:'English', key:'en'}];
...
export default {
    ...
    availableLanguagesOptions: availableLanguagesOptions,
    boxExtOptions: boxExtOptions
}